document.addEventListener('DOMContentLoaded', function () {
    // Filter data for Graham 
    const buildingData = wasteData.filter(item => item.Building.toLowerCase() === 'graham');
        ...
        return new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Waste Data Visualization for Graham (For each Month)',
                        font: {
                            size: 24
                        }
                    },
