document.addEventListener('DOMContentLoaded', function () {
    // Filter data for University Villas
    const buildingData = wasteData.filter(item => item.Building.toLowerCase() === 'university villas');
        ...
        return new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Waste Data Visualization for Campus Villas (For each Month)',
                        font: {
                            size: 24
                        }
                    },
