document.addEventListener('DOMContentLoaded', function () {
    // Filter data for Malley Center
    const buildingData = wasteData.filter(item => item.Building.toLowerCase() === 'malley');
        ...
        return new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Waste Data Visualization for Malley Center (For each Month)',
                        font: {
                            size: 24
                        }
                    },
