document.addEventListener('DOMContentLoaded', function () {
    // Filter data for learning commons
    const buildingData = wasteData.filter(item => item.Building.toLowerCase() === 'learning commons');
        ...
        return new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Waste Data Visualization for Learning Commons (For each Month)',
                        font: {
                            size: 24
                        }
                    },
