document.addEventListener('DOMContentLoaded', function () {
    // Filter data for Vari Hall and Lucas Hall
    const buildingData = wasteData.filter(item => item.Building.toLowerCase() === 'vari hall and lucas hall');
        ...
        return new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Waste Data Visualization for Vari Hall and Lucas Hall (For each Month)',
                        font: {
                            size: 24
                        }
                    },
