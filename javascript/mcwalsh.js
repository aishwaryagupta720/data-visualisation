document.addEventListener('DOMContentLoaded', function () {
    // Filter data for McWalsh 
    const buildingData = wasteData.filter(item => item.Building.toLowerCase() === 'mcwalsh');
        ...
        return new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Waste Data Visualization for McWalsh (For each Month)',
                        font: {
                            size: 24
                        }
                    },
